...
public interface InstrumentDriver {
     ...
     * @return populated AstmMessage object, or null if parsing fails
     * @throws Exception if parsing encounters an error
     */
     ...
     * @return formatted ASTM message string ready for transmission, or null if building fails
     * @throws Exception if building encounters an error
     */
